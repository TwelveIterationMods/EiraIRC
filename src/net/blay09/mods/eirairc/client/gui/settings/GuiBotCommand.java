...
public class GuiBotCommand extends GuiScreen {
	...
	public void initGui() {
		...
		txtCommand = new GuiAdvancedTextField(fontRenderer, leftX, topY, 100, 15);
		txtCommand.setDefaultText("Example: whitelist", true);
		txtCommand.setMaxStringLength(Integer.MAX_VALUE);
		txtMinecraftCommand = new GuiAdvancedTextField(fontRenderer, leftX, topY + 40, 150, 15);
	...
	public void drawScreen(int par1, int par2, float par3) {
		drawBackground(0);
		this.drawCenteredString(fontRenderer, Utils.getLocalizedMessage("irc.gui.botCommand"), width / 2, height / 2 - 110, Globals.TEXT_COLOR);
		drawString(fontRenderer, "Bot Command:", width / 2 - 170, height / 2 - 75, Globals.TEXT_COLOR);
		txtCommand.drawTextBox();
		drawString(fontRenderer, "Run Minecraft Command:", width / 2 - 170, height / 2 - 35, Globals.TEXT_COLOR);
