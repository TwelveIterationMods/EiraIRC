...
public class GuiEiraChatInput extends GuiScreen {
	...
	private void buildInputField() {
		txtInput = new GuiTextField(this.fontRenderer, 4, this.height - 12, this.width - 4, 12);
	...
	private void drawTargetOverlay() {
		...
		drawRect(0, 0, rectWidth, fontRenderer.FONT_HEIGHT + 6, GuiEiraChat.COLOR_BACKGROUND);
