...
public class GuiTwitch extends GuiScreen {
	...
	public void initGui() {
		...
		txtUsername = new GuiTextField(fontRendererObj, width / 2 - 50, height / 2 - 80, 100, 15);
		txtUsername.setMaxStringLength(Integer.MAX_VALUE);
		txtPassword = new GuiPasswordTextField(fontRendererObj, width / 2 - 50, height / 2 - 40, 100, 15);
	...
	public void drawScreen(int par1, int par2, float par3) {
		drawBackground(0);
		drawCenteredString(fontRendererObj, Utils.getLocalizedMessage("irc.gui.twitch"), width / 2, height / 2 - 115, Globals.TEXT_COLOR);
		drawCenteredString(fontRendererObj, Utils.getLocalizedMessage("irc.gui.twitch.username"), width / 2, height / 2 - 95, Globals.TEXT_COLOR);
		drawCenteredString(fontRendererObj, Utils.getLocalizedMessage("irc.gui.twitch.oauth"), width / 2, height / 2 - 55, Globals.TEXT_COLOR);
