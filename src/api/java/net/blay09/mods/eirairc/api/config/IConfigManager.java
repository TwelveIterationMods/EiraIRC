...
/**
 * Manages one or multiple sections of a configuration file; both .cfg and .json
 * Allows access to all of EiraIRC's configuration options as well as the ability to register custom options that can be used as
 * per-server or per-channel options by listening to the General/Bot/ThemeSettings InitConfigEvent and registering them tehre.
 */
