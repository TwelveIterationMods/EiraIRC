 ...
 * @author soniex2
 */
public abstract class IRCPrivateChatOrCTCPEvent extends IRCChatOrCTCPEvent {
    /**
     ...
     */
    public IRCPrivateChatOrCTCPEvent(IRCConnection connection, IRCMessage rawMessage, IRCUser sender, String message, boolean isNotice) {
