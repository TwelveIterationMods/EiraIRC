 ...
 * @author soniex2
 */
public abstract class IRCChannelChatOrCTCPEvent extends IRCChatOrCTCPEvent {
     ...
     */
    public IRCChannelChatOrCTCPEvent(IRCConnection connection, IRCMessage rawMessage, IRCUser sender, String message, boolean isNotice, IRCChannel channel) {
