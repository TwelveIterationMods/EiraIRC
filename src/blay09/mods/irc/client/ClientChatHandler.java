...
import blay09.mods.irc.command.IRCCommandHandler;
	...
	public static boolean processCommand(final EntityPlayer sender, String cmd, final String[] args) {
		if(cmd.equals("irc")) {
			try {
				...
				sender.sendChatToPlayer(Utils.getLocalizedChatMessage(EnumChatFormatting.RED + "Wrong Usage: " + e.getMessage(), "irc"));
				return true;
			}
